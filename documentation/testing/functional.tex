...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{evidence/retrieve.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{evidence/obtain.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{evidence/trace1.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.6]{evidence/trace2.png}
