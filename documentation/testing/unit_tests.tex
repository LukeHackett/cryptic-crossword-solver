...
The Resource Suite tests all the resources that are used to aid in the solving
...
Tests 96 and 97 give the three required parameters, but make the pattern and 
