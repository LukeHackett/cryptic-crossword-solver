 ...
 * additional functionality for easily sending repsonses back to the client.
 *
 * For consistency, all Servlets should extend this class.
 *
 * @author  Luke Hackett
 * @version 0.1
 */
public class Servlet extends HttpServlet {
	 ...
	 * The method is able to send both XML and JSON responses, and is denoted
	 * by the JSON boolean variable.
	 *
	 * @param response  HTTP response information
	 * @param payload   the data to send to the client
	 * @param json      should the response be in JSON (false gives XML)
	 */
